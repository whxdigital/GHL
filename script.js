  ...
  function processUserIntent(rawInput) {
    ...
    setTimeout(() => {
      ...
      // 7. Reviews / Proof
        ...
        appendBotMsg(`
          <strong>10 Verified Client Reviews across Global Platforms:</strong><br/>
          Check our verified client feedback from Upwork, LinkedIn, Google, Trustpilot, Clutch, G2, Fiverr Pro, GitHub, Enterprise SLA, and ProductHunt:
          <a href="reviews.html" class="bot-action-badge"><i class="fa-solid fa-star" style="color:#eab308;"></i> Explore 10 Verified Client Reviews →</a>
        `);
      }
